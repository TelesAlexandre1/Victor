...
function(e, t) {
  ...
  function E(e) {
    ...
    return i && ("html" === l(i) || "body" === l(i) && "static" === m(i).position) ? n: i ||
    function(e) {
  ...
  function I(e, r, o) {
    return r === H ? N(function(e, n) {
      ...
      if (i) {
        a = i.width,
        s = i.height;
        var u = c(); (u || !u && "fixed" === n) && (f = i.offsetLeft, p = i.offsetTop)
      }
      return {
        width: a,
        height: s,
  ...
  function Z(e) {
    ...
    return function(e, t, r) {
      ...
      return u.setOptions(r).then((function(e) { ! p && r.onFirstUpdate && r.onFirstUpdate(e)
      })),
      u
    }
  }
  ...
  function re(e) {
    ...
    if (u) {
      ...
      H = "clientHeight",
      T = "clientWidth";
      if (W === t(r) && "static" !== m(W = d(r)).position && "absolute" === c && (H = "scrollHeight", T = "scrollWidth"), W = W, i === D || (i === P || i === L) && a === B) M = A,
      b -= (h && W === k && k.visualViewport ? k.visualViewport.height: W[H]) - o.height,
      b *= p ? 1 : -1;
      if (i === P || (i === D || i === A) && a === B) j = L,
  ...
  var le = {
    ...
    fn: function(e) {
      ...
      if (!t.modifiersData[r]._skip) {
        ...
        y = F(v), g = f || (y === v || !h ? [fe(v)] : function(e) {
          if (F(e) === M) return [];
          var t = fe(e);
          return [pe(e), t, pe(t)]
  ...
  var he = {
    ...
    fn: function(e) {
      ...
      B = t.rects.reference,
      H = t.rects.popper,
      T = "function" == typeof y ? y(Object.assign({},
      t.rects, {
        placement: t.placement
      })) : y,
      R = "number" == typeof T ? {
